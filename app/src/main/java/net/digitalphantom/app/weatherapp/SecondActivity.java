/**
 *
 *  Modified by Karl Elmore to allow for input of 2 cities on 2 screens
 *
 */
...
public class SecondActivity extends AppCompatActivity implements WeatherServiceListener, GeocodingServiceListener, LocationListener {
    ...
    public void switch_city(View view){
        ...
        Intent switchToFirstCity = new  Intent();
        switchToFirstCity.setClass(this, WeatherActivity.class);
        startActivity(switchToFirstCity);
